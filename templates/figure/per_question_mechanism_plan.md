...
> 状态：deprecated compatibility pointer。该路径仅保留旧项目与旧人工链接兼容，不属于当前默认运行链，也不再维护独立的“每问机理图规划表”。

当前项目的机理/推导图规划已经并入现行项目记忆与 Figure Contract：

- 每问“为什么需要这张图、支撑哪条公式/约束、正文放在哪里、是否为核心证据”等信息，登记在项目根目录 `模型论文框架.md`；
- 单张机理/推导图的字段与证据链接使用 `templates/figure/mechanism_contract.md`；
