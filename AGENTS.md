...
8. New projects use `问题X求解结果.xlsx` and `问题X结果深化分析.xlsx`. The historical `问题X敏感性与鲁棒性结果.xlsx` name is read-only compatibility and must not be generated by active templates.
