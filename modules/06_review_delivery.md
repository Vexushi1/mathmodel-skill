...
按 current Registry 检查 canonical term、discouraged alias 和 confusable terms；不为“词汇丰富”轮换同义词，也不由机器自判陌生词等价。
...
以下**不再自动列为 Blocking**：问题章节内部二级/三级小节超过经验数量、标题较长、使用“基于/的”等语法、段落公式较多。只有实际造成语义断裂、证据缺失、模板违规或 Hard 冲突时才 blocking。
