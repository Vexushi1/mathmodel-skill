...
P9_RELEASE_VERSIONS = {"9.1.0", "9.2.0", "9.2.1", "9.3.0", "9.3.1", "9.4.0", "9.4.1", "9.4.2", "9.4.3", "9.4.4", "9.5.0"}
...
def main():
    ...
    report = {
        ...
        "interpretation": "Initial planned ranges, not actual reads/tokens or total task cost; approved authority hashes, the P7 conditional-analysis prerequisite removal, and the explicitly registered 9.1.0-to-9.5.0 release carriers are normalized while every other legacy field remains exact.",
        "cases": rows,
    }
