...
class V1000ReleaseVersionMatrixTests(unittest.TestCase):
    def test_current_skill_carriers_and_single_backend_cli(self):
        ...
        self.assertEqual(plugin["version"], "10.0.1")
        ...
        for relative in (
            ...
            with self.subTest(relative=relative):
                self.assertEqual(str(load(relative)["version"]), "10.0.1")
        self.assertEqual(
        ...
        self.assertIn("version: 10.0.1", root_skill)
        readme = (ROOT / "README.md").read_text(encoding="utf-8")
        changelog = (ROOT / "CHANGELOG.md").read_text(encoding="utf-8")
        self.assertTrue(readme.startswith("# mathmodel-skill v10.0.1"))
        self.assertEqual(readme.splitlines()[0], "# mathmodel-skill v10.0.1")
        self.assertTrue(changelog.startswith("# Changelog\n\n## 10.0.1\n"))
        self.assertTrue((ROOT / "core/hsk_core_policy.md").read_text(encoding="utf-8").startswith("# HSK Core Policy v10.0.1"))
