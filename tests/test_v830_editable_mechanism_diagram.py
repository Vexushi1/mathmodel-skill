...
class ContractAndDriftTests(unittest.TestCase):
    ...
    PROTECTED = {
        ...
        # B1 adds exact numeric claim records; test_claim_contract protects the predecessor schema.
        "core/project_state.schema.yaml": "dab3912b52ec32d530d59e03c74cf8e8f01f8890",
