...
class ContractAndDriftTests(unittest.TestCase):
    ...
    PROTECTED = {
        ...
        "core/writing_reasoning_contract.yaml": "19ff592d877aca384a9cd66483f10cb3eb1f88d9",
        ...
        "modules/05_writing/paper_writing_protocol.md": "4a86f7a1fdeb6896f2b14248d716a845fba5b244",
        "modules/05_writing/ai_cleanup.md": "4f5f3682707482b924b6901f1006087e27c5e6da",
        "modules/06_review_delivery.md": "0666ee28fb403429f05514ef2dc97b44ff55967e",
    ...
    def test_protected_authorities_have_not_drifted(self):
        # W1 proof-body preservation and judge-readable heading/terminology changes intentionally
        # re-pin only the touched writing authorities; the guard remains exact and continues
        # to fail closed on any later unrelated drift.
