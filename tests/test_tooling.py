...
class TestTooling(unittest.TestCase):
    ...
    def test_matlab_templates_use_unique_headers_and_caption_owned_titles(self):
        ...
        self.assertIn("seriesColors = zeros(0, 3)", plotting)
        self.assertIn('"Color", seriesColors(1, :)', plotting)
        ...
        self.assertIn("高对比、中高饱和", profile)
        self.assertIn('case "journal_balanced"', profile)
        self.assertIn('case "monochrome_print"', profile)
        self.assertIn("palette.primary", profile)
