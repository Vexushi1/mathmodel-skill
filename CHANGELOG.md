...
- Upgraded `模型论文框架.md` to `v0.8-project-memory` with standard model type, formal model name, Model/Solver/Validator roles, optimization-objective abstract closure, solver evidence roles, subsection planning, and headline claim Evidence Level/Scope.
